...
#define USE_LCD_STR_E 	0			// wysy≥a string umieszczony w pamiÍci FLASH

#define USE_LCD_INT 	0			// wyúwietla liczbÍ dziesietnπ na LCD
...
#define USE_LCD_DEFCHAR_E 	0		// wysy≥a zdefiniowany znak z pamiÍci EEPROM
